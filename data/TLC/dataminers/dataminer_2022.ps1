# Download all 2022 TLC trip record files listed on the official page.
param(
    [string]$OutDir = "..\2022"
)
...
$pattern = 'https?://d37ci6vzurychx\.cloudfront\.net/trip-data/[a-z]+_tripdata_2022-(0[1-9]|1[0-2])\.parquet'
$links = [Regex]::Matches($html, $pattern) |
         ForEach-Object { $_.Value } |
         Sort-Object -Unique

if ($links.Count -eq 0) { throw "No 2022 file links found. Page structure or host changed?" }
