# Download all 2023 TLC trip record files listed on the official page.
param(
    [string]$OutDir = "..\2023"
)
...
# Find all 202X cloudfront PARQUET links (yellow/green/fhv/fhvhv)
$pattern = 'https?://d37ci6vzurychx\.cloudfront\.net/trip-data/[a-z]+_tripdata_2023-(0[1-9]|1[0-2])\.parquet'
$links = [Regex]::Matches($html, $pattern) |
         ForEach-Object { $_.Value } |
         Sort-Object -Unique

if ($links.Count -eq 0) { throw "No 2023 file links found. Page structure or host changed?" }
