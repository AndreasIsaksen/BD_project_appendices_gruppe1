# Download all 2025 TLC trip record files listed on the official page.
param(
    [string]$OutDir = "..\2025"
)
...
# Find all 2025 cloudfront PARQUET links (yellow/green/fhv/fhvhv)
$pattern = 'https?://d37ci6vzurychx\.cloudfront\.net/trip-data/[a-z]+_tripdata_2025-(0[1-9]|1[0-2])\.parquet'
$links = [Regex]::Matches($html, $pattern) |
         ForEach-Object { $_.Value } |
         Sort-Object -Unique

if ($links.Count -eq 0) { throw "No 2025 file links found. Page structure or host changed?" }
